...
const items = [
  ...
  {
    url: 'https://visitacolima.mx/conoce-colima/comala',
    buttonLabel: 'Seleccionar',
    img: 'https://visitacolima.mx/images/2023/08/08/jardn-de-comala-pueblo-mgico-foto-hernando-rivera1.jpg',
    title: 'Qué hacer en Comala.',
    button: true,
